                ...
                <div class="col-md-8">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            ?>
                            <form role="form" action="proses/update_password.php" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-6">                      
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="password_baru" type="text" autofocus required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">                      
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="password_lama" type="text" required />
                                        </div>
                                    </div>
