                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="alert alert-danger" >
                                <strong>PERHATIAN :</strong> Perhatikan Data Nilai yang akan diimportkan bahwa setiap nilai harus sesuai masing-masing ID Siswa yang belum diinputkan nilai.
                            </div>

                            <form role="form" action="proses/import_nilai.php" method="post" enctype="multipart/form-data">

                                <div class="row">
                                    <div class="col-md-12">                    
                                        <div class="form-group">
                                            <label>Input File Excel</label>
                                            <input class="form-control" name="data_nilai" type="file" />
                                        </div>
