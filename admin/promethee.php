                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active in" id="home">
                                    <h4>Beranda</h4>
                                    <p>Menentukan Kelas Unggulan dengan menggunakan <b>Algoritma Promethee</b>.
                                ...
                                <div class="tab-pane fade" id="bobot">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            include('../koneksi.php');
                                            $no=0;
                                            $data = mysqli_query($koneksi,"SELECT tb_konversi_1.*, tb_siswa.`nama` FROM tb_konversi_1 JOIN tb_siswa ON tb_konversi_1.`id_siswa` = tb_siswa.`id` WHERE id_tahun_ajaran = $id_tahun_ajaran order by tb_siswa.`nama` ASC");
                                ...
                                <div class="tab-pane fade" id="unggulan">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <?php
                                            $no=0;
                                            $data = mysqli_query($koneksi,"SELECT tb_siswa.`nisn`, tb_siswa.`nama`, tb_nilai.* FROM tb_siswa JOIN tb_nilai ON tb_siswa.`id` = tb_nilai.`id_siswa` WHERE id_tahun_ajaran = $id_tahun_ajaran order by tb_nilai.`hasil_promethee` DESC");
                                            while($row = mysqli_fetch_array($data)){ 
                                            $no++;
                                            ?>
                                                <tr class="odd gradeX">
                                    ...
                                    <a href="cetak_semua_pr.php" target="_blank"><button class="btn btn-info btn-sm"><i class="fa fa-download"></i> Cetak</button></a>
    ...
    <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
      <div class="modal-dialog modal-sm" role="document">
        ...
        <div class="modal-content">
          ...
          <form role="form" action="proses/proses_promethee.php" method="post">
